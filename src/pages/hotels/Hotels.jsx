                      ...
                      <div className="flex items-start justify-between gap-3">
                        ...
                        {status === "pending" ? (
                          <button
                            ...
                            className="flex-shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-amber-50 text-amber-600 border border-amber-200 hover:bg-amber-100 hover:border-amber-300 transition-all duration-200 cursor-pointer"
                          >
                    ...
                    <div className="px-6 py-4 space-y-3">
                      ...
                      <div className="flex items-center gap-3 text-sm text-gray-600">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="font-medium text-gray-700 truncate">{hotel.admin?.profile?.name || "N/A"}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 text-sm text-gray-600">
                        ...
                        <div className="min-w-0">
                          <p className="text-xs text-gray-400 leading-none">Phone</p>
                          <p className="font-medium text-gray-700">{hotel.phone || "N/A"}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 text-sm text-gray-600">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="font-medium text-gray-700 truncate">{hotel.email || "N/A"}</p>
                        </div>
                      </div>
                    </div>
